...
int nitea,niter,nconv,nb,nl,ng,nz,lf,lim,ntot,limite,nitqm;

double tol,carga,tola,tolr,dtap,range,alfa;

/*--------
  Vetores:
  ------*/

int itipo[nbmax],itipob[nbmax],nslack[nbmax],nex[nbmax],ni[nlmax],
           nf[nlmax],ltc[nlmax],noze[nbmax],lrd[nbmax],lcol[nbmax],nseq[nbmax],
           itag[maxnzero],lnxt[maxnzero];

double  v[nbmax],ves[nbmax],qes[nbmax],q[nbmax],pes[nbmax],pca[nbmax],
