...
*/
	...
	conting_item_data_set_attr(CONTING_ITEM_DATA(item_data),
			...
			"load flow area", G_TYPE_INT, branch_data.load_flow_area,
			"loss zone", G_TYPE_INT, branch_data.loss_zone,
			"circuit", G_TYPE_INT, branch_data.circuit,
			"type", G_TYPE_INT, branch_data.type,
			"branch resistance", G_TYPE_DOUBLE, branch_data.branch_resistance,
			"branch reactance", G_TYPE_DOUBLE, branch_data.branch_reactance,
			"line charging", G_TYPE_DOUBLE, branch_data.line_charging,
			"line mva 1", G_TYPE_INT, branch_data.line_mva_1,
			"line mva 2", G_TYPE_INT, branch_data.line_mva_2,
			"line mva 3", G_TYPE_INT, branch_data.line_mva_3,
			"control bus number", G_TYPE_INT, branch_data.control_bus_number,
			"side", G_TYPE_INT, branch_data.step_size,
			"trans final ratio", G_TYPE_DOUBLE, branch_data.trans_final_ratio,
			"trans final angle", G_TYPE_DOUBLE, branch_data.trans_final_angle,
			"min tap phase shift",
			G_TYPE_DOUBLE, branch_data.min_tap_phase_shift,
			"max tap phase shift",
			G_TYPE_DOUBLE, branch_data.max_tap_phase_shift,
			"step size", G_TYPE_DOUBLE, branch_data.step_size,
			"min voltage", G_TYPE_DOUBLE, branch_data.min_voltage,
			"max voltage", G_TYPE_DOUBLE, branch_data.max_voltage,
			NULL);
