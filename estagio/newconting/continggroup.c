...
static void
conting_group_grab(ContingDrawing *self, ArtPoint *pi)
{
    ContingGroupPrivate *priv;
...
static void
conting_group_ungrab(ContingDrawing *self)
{
    ContingGroupPrivate *priv;
...
static void
conting_group_motion(ContingDrawing *self, ArtPoint *pi)
{
    ContingGroupPrivate *priv;
    ...
    if (priv->grabbed) {
        ...
        for (n = priv->drawings; n != NULL; n = g_slist_next(n)) {
            conting_drawing_affine(n->data, affine);
            g_signal_emit_by_name(n->data, "move");
        }
...
conting_group_class_init(gpointer g_class, gpointer class_data)
{
    ...
    drawing_class->grab = conting_group_grab;
    drawing_class->ungrab = conting_group_ungrab;
    drawing_class->motion = conting_group_motion;
