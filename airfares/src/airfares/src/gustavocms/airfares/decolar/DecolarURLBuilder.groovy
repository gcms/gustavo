...
//        http://www.us.despegar.com/shop/flights/data/search/multipledestinations/gyn,mvd/bue,gyn/2013-11-19,2013-12-01/1/0/0/TOTALFARE/ASCENDING
    ...
    public URL buildOneWayURL(ItineraryQuery query) {
        DateFormat format = new SimpleDateFormat('yyyy-MM-dd')
        ...
        new URL("http://www.us.despegar.com/shop/flights/data/search/oneway/${from}/${to}/${day}/1/0/0/TOTALFARE/ASCENDING/NA/NA/NA/NA")
    }
}
