...
//    browser = "*firefox"
	browser = "*firefox ${System.getProperty('user.home')}/Configurações locais/Dados de aplicativos/Mozilla Firefox/firefox.exe"							// can include full path to executable, default value is *firefox or *iexplore on Windows
