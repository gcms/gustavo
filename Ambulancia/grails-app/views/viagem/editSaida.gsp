...
<div class="body">
  ...
  <g:form method="post">
    ...
    <div class="buttons">
      <span class="button"><g:actionSubmit class="save" action="updateSaida" value="${message(code: 'update', 'default': 'Update')}"/></span>
      <span class="button"><g:actionSubmit class="delete" action="deleteSaida" value="${message(code: 'delete', 'default': 'Delete')}" onclick="return confirm('${message(code: 'delete.confirm', 'default': 'Are you sure?')}');"/></span>
    </div>
  </g:form>
</div>
</body>
