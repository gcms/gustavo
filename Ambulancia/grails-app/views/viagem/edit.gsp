                    ...
                    <table>
                        <tbody>
                            ...
                            %{--<tr class="prop">--}%
                                ...
                                %{--<td valign="top" class="value ${hasErrors(bean: viagemInstance, field: 'motorista', 'errors')}">--}%
                                    %{--<g:select name="motorista.id" from="${br.gov.go.saude.hugo.ambulancia.Motorista.list()}" optionKey="id" value="${viagemInstance?.motorista?.id}"  />--}%
                        ...
                        %{----}%
                            %{--<tr class="prop">--}%
                                ...
                                %{--<td valign="top" class="value ${hasErrors(bean: viagemInstance, field: 'ambulancia', 'errors')}">--}%
                                    %{--<g:select name="ambulancia.id" from="${br.gov.go.saude.hugo.ambulancia.Ambulancia.list()}" optionKey="id" value="${viagemInstance?.ambulancia?.id}"  />--}%
                        ...
                        %{----}%
                            %{--<tr class="prop">--}%
                                ...
                                %{--</td>--}%
                                %{--<td valign="top" class="value ${hasErrors(bean: viagemInstance, field: 'operador', 'errors')}">--}%
                                    %{--<g:select name="operador.id" from="${br.gov.go.saude.hugo.ambulancia.Operador.list()}" optionKey="id" value="${viagemInstance?.operador?.id}"  />--}%
