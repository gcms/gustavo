  ...
  <g:form>
    ...
    <div class="dialog">
      <table>
        ...
        <tr class="prop">
          <td valign="top" class="name"><g:message code="operador.telefone" default="Telefone"/>:</td>

          <td valign="top" class="value">${fieldValue(bean: operadorInstance, field: "telefone")}</td>
        </tr>
