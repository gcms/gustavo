...
/*-----------------------------------zollen.c----------------------------------------------
 ...
 matriz para a forma LDU e resolver o sistema reduzido LDUx=b   
 Faz a ordenacao de como a matriz deve ser fatorada para evitar o aparecimento de "fill-ins"

 Contem as seguintes subrotinas:
                                1) redu -> Subrotina para obter os fatores triangulares
                                           L, D, U de uma matriz qualquer
                                2) solu -> Subrotina para obter a solu�o do sistema L.D.U.x = b       
...
/*---------------Inicio da funcao solu----------------*/

//Chamada pela funcao state do arquivo state.c
